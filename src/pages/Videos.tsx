  ...
  const featuredVideos = [
    {
      ...
      description:
        "Follow our 18-month journey building a state-of-the-art commercial complex in the heart of downtown.",
      thumbnail: "downtown.png",
      duration: "12:45",
      views: "15.2K",
    ...
    },
    {
      ...
      description:
        "Discover how we coordinate complex construction projects with precision and efficiency.",
      thumbnail: "behind.png",
      duration: "8:30",
      views: "8.7K",
    ...
    },
    {
      ...
      description:
        "Watch 24 months of luxury home construction condensed into an amazing 5-minute time-lapse.",
      thumbnail: "luxury.png",
      duration: "5:20",
      views: "22.1K",
      category: "Project Showcases",
      date: "2024-01-05",
  ...
  const allVideos = [
    {
      ...
      description:
        "Hear directly from our client about their experience with our industrial construction services.",
      thumbnail: "v1.jpg",
      duration: "6:15",
      views: "5.3K",
    ...
    },
    {
      ...
      description:
        "Learn about our industry-leading safety measures that keep our teams and projects secure.",
      thumbnail: "casestudies2.png",
      duration: "9:40",
      views: "7.8K",
      category: "Company Insights",
      date: "2023-12-20",
    },
    {
      ...
      description:
        "Explore our commitment to environmentally responsible construction methods and materials.",
      thumbnail: "casestudies.png",
      duration: "11:25",
      views: "4.9K",
    ...
    },
    {
      ...
      description:
        "Get to know the talented engineers who bring our construction visions to life.",
      thumbnail: "behindthescenes.png",
      duration: "7:55",
      views: "6.2K",
      category: "Company Insights",
      date: "2023-12-10",
    },
    {
      ...
      description:
        "See how we use cutting-edge BIM technology to improve project accuracy and efficiency.",
    ...
    },
    {
      ...
      description:
        "Premium Homes LLC shares their experience working with us on their luxury residential project.",
      thumbnail: "glossory.jpg",
      duration: "4:45",
      views: "3.7K",
      category: "Client Testimonials",
      date: "2023-11-30",
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-2xl mb-12 max-w-4xl mx-auto leading-relaxed opacity-90">
            Explore our comprehensive video library featuring project
            time-lapses, behind-the-scenes content, client testimonials, and
            industry expertise from our construction professionals.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {videoCategories.map((category, idx) => (
              <div
                key={idx}
                className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 text-center hover:shadow-xl transition-shadow cursor-pointer"
              >
                <div
                  className={`inline-flex px-4 py-2 rounded-full text-sm font-medium mb-4 ${category.color}`}
                >
                  {category.name}
                </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Stay updated with our latest project showcases, industry insights,
