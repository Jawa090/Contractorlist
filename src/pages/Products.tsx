...
const Products = () => {
  ...
  const products = [
    {
      ...
      features: [
        ...
        { icon: Zap, text: "10x Faster", desc: "Instant calculations" },
        {
          ...
          desc: "Scalable AI infrastructure",
        },
      ],
      metrics: {
        accuracy: "99.8%",
      ...
      features: [
        {
          ...
          desc: "Millions of data points",
        },
        {
          icon: TrendingUp,
          text: "Market Intelligence",
          desc: "Real-time pricing",
        },
    ...
    },
    {
      ...
      metrics: {
        accuracy: "98% satisfaction",
        speed: "<1s response",
        savings: "80% support costs",
      },
    ...
    },
    {
      ...
      metrics: {
        accuracy: "92% task success",
        speed: "5x productivity",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50 relative overflow-hidden">
        ...
        <div className=" relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed">
              Experience the future of construction with our revolutionary
              AI-powered tools that learn, adapt, and optimize your workflow
            </p>
          </div>
      ...
      <section className="relative mx-18 mt-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Each product powered by cutting-edge machine learning and neural
              networks
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {products.map((product, index) => {
              ...
              return (
                <Card
                  key={product.id}
                  className={`group hover:shadow-2xl ${product.glowColor} transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 border-0 shadow-xl overflow-hidden bg-white/90 backdrop-blur-sm`}
                >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Ready to Experience
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#fce011] to-yellow-400">
                {" "}
                AI Power?
              </span>
            </h2>
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join thousands of contractors already using our AI solutions to
              revolutionize their business operations and increase
              profitability.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                {isProcessing
                  ? "AI Processing..."
                  : "Click to simulate AI processing"}
              </p>
            </button>
            ...
            <div className="p-8 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
              ...
              <p className="text-gray-300 text-sm">
                Bank-level security & 99.9% uptime
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              <Link to="/about-us" className="flex items-center text-black">
                <Eye className=" h-5 w-5 text-black" />
                <p className="text-black">Watch Demo</p>
              </Link>
            </Button>
          </div>
        </div>
