...
import StatCard from "@/components/GC dashboard/StatCard";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 stat-card overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            ...
            <Link to="/gc-dashboard/projects" className="text-xs text-primary dark:text-yellow-400 font-medium flex items-center gap-1 hover:underline">
      ...
      {latestPayApp && (
        <div className="mt-6 stat-card">
          <div className="px-5 py-4 border-b border-border flex items-center justify-between">
            ...
            <Link to="/gc-dashboard/financials" className="text-xs text-primary dark:text-yellow-400 font-medium flex items-center gap-1 hover:underline">
