  ...
  const aiFeatures = [
    {
      ...
      desc: "Advanced image recognition analyzes blueprints and 3D models",
    },
    {
      icon: Brain,
      title: "Neural Networks",
      desc: "Deep learning algorithms trained on millions of construction documents",
    },
    {
      icon: Target,
      title: "99.8% Accuracy",
      desc: "Industry-leading precision validated by 10,000+ projects",
    },
    {
      icon: Zap,
      title: "Real-time Processing",
      desc: "Instant calculations with cloud-based AI infrastructure",
    },
    {
      icon: Database,
      title: "Smart Learning",
      desc: "Continuously improves from every processed document",
    },
    {
      icon: Network,
      title: "API Integration",
      desc: "Seamlessly connects with your existing workflow tools",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-700 leading-relaxed mb-8 text-justify">
                AI Quantity Take Off is a revolutionary AI-powered solution
                designed to transform the way construction and design
                professionals estimate materials. Using advanced computer vision
                and machine learning, it analyzes blueprints, CAD drawings, and
                3D models to automatically calculate material quantities with
                unmatched accuracy. By detecting walls, beams, slabs, and other
                structural elements, it generates precise material lists in real
                time, reducing manual effort and human error. Beyond accurate
                estimation, AI Quantity Take Off streamlines project planning
                and procurement by providing detailed, exportable reports and
                real-time updates whenever design changes occur. It helps
                optimize costs, minimize material waste, and improve
                collaboration across teams, making construction projects more
                efficient, predictable, and cost-effective from start to finish.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            {metrics.map((metric, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300"
                >
            ...
            {[
              {
                ...
                desc: "Single-family homes, condos, and apartment complexes",
                savings: "40% time reduction",
              },
              {
                title: "Commercial Buildings",
                desc: "Office towers, retail spaces, and mixed-use developments",
                savings: "60% accuracy improvement",
              },
              {
                title: "Infrastructure Projects",
                desc: "Roads, bridges, and public works projects",
                savings: "$2M average cost savings",
              },
              {
                title: "Industrial Facilities",
                desc: "Manufacturing plants, warehouses, and distribution centers",
                savings: "85% faster estimates",
              },
              {
                title: "Healthcare Facilities",
                desc: "Hospitals, clinics, and medical office buildings",
                savings: "99.8% compliance rate",
              },
              {
                title: "Educational Buildings",
                desc: "Schools, universities, and training facilities",
                savings: "50% project acceleration",
              },
            ].map((useCase, index) => (
              <Card
                key={index}
      ...
      <section className="relative z-10 py-20 bg-gradient-to-r from-yellow-400 to-yellow-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-black/80 mb-8">
            Join 10,000+ construction professionals using AI to accelerate their
            projects
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact-us">
              <Button
                size="lg"
                className="bg-black hover:bg-gray-800 text-white font-bold px-8 py-4"
              >
                <Brain className="mr-2 h-5 w-5" />
                Start Free Trial
              </Button>
            ...
            <Link to="/contact-us">
              <Button
                size="lg"
                variant="outline"
                className="border-black text-black hover:bg-black hover:text-white font-bold px-8 py-4"
              >
                Schedule Demo
              </Button>
            </Link>
