  ...
  const aiCapabilities = [
    {
      ...
      desc: "Learns your workflow patterns and automates repetitive tasks",
    },
    {
      icon: Brain,
      title: "Intelligent Scheduling",
      desc: "Optimizes calendars and resource allocation using ML algorithms",
    },
    {
      icon: Calendar,
      title: "Project Orchestration",
      desc: "Coordinates complex multi-phase construction projects",
    },
    {
      icon: Mic,
      title: "Voice Commands",
      desc: "Natural language processing for hands-free operation",
    },
    {
      icon: Network,
      title: "System Integration",
      desc: "Connects with 100+ construction and business tools",
    },
    {
      icon: Shield,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-justify text-gray-700 leading-relaxed mb-8">
                The AI Virtual Assistant is designed to redefine productivity by
                combining Automation and Workflow Intelligence. It observes and
                learns from user behavior, identifying repetitive processes and
                optimizing them through smart automation. From scheduling
                meetings and managing tasks to tracking project milestones, it
                intelligently adapts to your workflow, ensuring smoother
                operations and faster decision-making without manual
                intervention. Powered by advanced machine learning algorithms,
                this assistant doesn’t just execute commands—it understands
                priorities, anticipates needs, and provides actionable insights
                for better project outcomes. Its seamless integration with
                existing tools and platforms enables real-time collaboration,
                reporting, and task coordination across teams.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Real-time workflow optimization metrics
            </p>
          </div>
