...
const VendorSidebar = ({ activeTab, setActiveTab, isCollapsed, onToggle }: VendorSidebarProps) => {
  const menuItems = [
        ...
        {!isCollapsed && (
          <div className="p-4 border-t border-gray-700/50 bg-gray-800/50">
            <div className="bg-gradient-to-r from-yellow-400/10 to-orange-500/10 border border-yellow-400/20 rounded-xl p-4">
              <p className="text-xs font-semibold text-yellow-400 mb-2">🏪 Your Store</p>
              <p className="text-sm text-white font-medium mb-3">Demo Vendor Store</p>
