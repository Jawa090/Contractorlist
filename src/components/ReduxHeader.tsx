...
const ReduxHeader = () => {
  ...
  const { isMobileMenuOpen, activeDropdown } = useAppSelector((state) => state.ui);
  ...
  const handleDropdownToggle = (dropdownName: string) => {
    dispatch(setActiveDropdown(activeDropdown === dropdownName ? null : dropdownName));
  };
          ...
          <nav className="hidden md:flex items-center space-x-8 text-base font-medium">
              ...
              <DropdownMenuContent align="start" className="w-64">
                ...
                <DropdownMenuItem className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Streamlined bidding processes</div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Accurate project cost analysis</div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Efficient tender processes</div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                  <ShoppingCart className="h-5 w-5 text-yellow-600" />
                  <div>
                    <div className="font-medium">Procurement & Pre-Contract Management</div>
                    <div className="text-xs text-gray-500">Strategic procurement solutions</div>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-64">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem asChild>
                  <Link to="/about-us" className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/case-studies" className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/articles" className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/glossary" className="flex items-center space-x-3 p-3 cursor-pointer hover:bg-yellow-50">
