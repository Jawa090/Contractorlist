...
import { AnnotationType, ANNOTATION_COLORS, STROKE_WIDTHS } from "@/hooks/GC dashboard/useAnnotations";
import { ScaleCalibration } from "@/hooks/GC dashboard/useScaleCalibration";
import { HistoryEntry } from "@/hooks/GC dashboard/useAnnotationHistory";
