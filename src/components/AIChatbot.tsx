        ...
        <div className="fixed bottom-6 right-6 w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden">
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            <div className="flex items-center gap-2">
              <div className="flex-1 relative">
                <textarea
                  ...
                  className="w-full p-3 pr-12 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  rows={1}
                />
              ...
              <button
                ...
                className="p-3 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 disabled:from-gray-300 disabled:to-gray-400 text-black rounded-xl transition-all duration-200 transform hover:scale-105 disabled:scale-100 shadow-lg hover:shadow-xl border border-yellow-600"
              >
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button className="px-3 py-1 bg-amber-100 hover:bg-amber-200 text-amber-800 text-xs rounded-full transition-colors duration-200 border border-amber-300">
                Cost Estimate
              </button>
              <button className="px-3 py-1 bg-orange-100 hover:bg-orange-200 text-orange-800 text-xs rounded-full transition-colors duration-200 border border-orange-300">
                Project Help
              </button>
            </div>
          </div>
