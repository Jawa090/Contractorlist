...
import { AnnotationType, ANNOTATION_COLORS, STROKE_WIDTHS } from "@/apps/gc/hooks/useAnnotations";
import { ScaleCalibration } from "@/apps/gc/hooks/useScaleCalibration";
import { HistoryEntry } from "@/apps/gc/hooks/useAnnotationHistory";
