...
import { Tabs, TabsList, TabsTrigger } from "@/apps/gc/components/ui/tabs";
import {
  Select,
  SelectContent,
  SelectItem,
                  ...
                  return (
                    <TableRow key={rfi.id} className="cursor-pointer hover:bg-muted/50">
                      <TableCell className="font-mono text-xs">
                        <Link to={`/gc-dashboard/projects/${rfi.project_id}?tab=rfis`} className="hover:underline">
                          RFI-{rfi.rfi_number}
                        </Link>
                      </TableCell>
                      <TableCell>
                        <Link to={`/gc-dashboard/projects/${rfi.project_id}`} className="hover:underline text-primary">
                          {rfi.project?.name}
                        </Link>
                      </TableCell>
                      <TableCell>
