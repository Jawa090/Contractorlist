                  ...
                  return (
                    <TableRow key={co.id} className="cursor-pointer hover:bg-muted/50">
                      <TableCell className="font-mono text-xs">
                        <Link to={`/gc-dashboard/projects/${co.project_id}?tab=change-orders`} className="hover:underline">
                          CO-{co.co_number}
                        </Link>
                      </TableCell>
                      <TableCell>
                        <Link to={`/gc-dashboard/projects/${co.project_id}`} className="hover:underline text-primary">
                          {co.project?.name}
                        </Link>
                      </TableCell>
                      <TableCell>
