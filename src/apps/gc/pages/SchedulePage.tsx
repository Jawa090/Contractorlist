...
import { useMilestones, type Milestone } from "@/apps/gc/hooks/useMilestones";
import GanttChart from "@/apps/gc/components/schedule/GanttChart";
import AddMilestoneDialog from "@/apps/gc/components/schedule/AddMilestoneDialog";
import MilestoneDetailDialog from "@/apps/gc/components/schedule/MilestoneDetailDialog";
    ...
    return (
      <div className="p-6 animate-fade-in">
        <div className="stat-card p-8 text-center">
          ...
          <Button asChild>
            <Link to="/gc-dashboard/projects">Go to Projects</Link>
          </Button>
        </div>
      </div>
    );
