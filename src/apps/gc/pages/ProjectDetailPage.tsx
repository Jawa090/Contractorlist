...
import { useProject } from "@/apps/gc/hooks/useProjectDetail";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/apps/gc/components/ui/tabs";
import {
  ArrowLeft,
  MapPin,
  Calendar,
...
import ProjectDashboardTab from "@/apps/gc/components/project/ProjectDashboardTab";
import ProjectRFIsTab from "@/apps/gc/components/project/ProjectRFIsTab";
import ProjectChangeOrdersTab from "@/apps/gc/components/project/ProjectChangeOrdersTab";
import ProjectTeamTab from "@/apps/gc/components/project/ProjectTeamTab";
import ProjectDailyLogsTab from "@/apps/gc/components/project/ProjectDailyLogsTab";
import ProjectScheduleTab from "@/apps/gc/components/project/ProjectScheduleTab";
import ProjectDocumentsTab from "@/apps/gc/components/project/ProjectDocumentsTab";
import ProjectPlansTab from "@/apps/gc/components/project/ProjectPlansTab";
import ProjectBudgetTab from "@/apps/gc/components/project/ProjectBudgetTab";
import ProjectSignaturesTab from "@/apps/gc/components/project/ProjectSignaturesTab";
    ...
    return (
      <div className="p-6">
        <div className="stat-card p-8 text-center">
          ...
          <Link to="/gc-dashboard/projects" className="text-primary hover:underline">
            ← Back to Projects
          </Link>
        </div>
      </div>
