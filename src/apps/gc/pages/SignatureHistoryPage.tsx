...
import { useSignatureHistory } from "@/apps/gc/hooks/useSignatureHistory";
                  ...
                  {filteredHistory.map((item) => {
                    ...
                    return (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <Link
                            to={`/gc-dashboard/projects/${item.project_id}`}
                        ...
                        <TableCell>
                          <Link to={`/gc-dashboard/projects/${item.project_id}`}>
