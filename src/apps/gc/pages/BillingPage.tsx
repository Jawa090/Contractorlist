                  ...
                  return (
                    <TableRow key={pa.id} className="cursor-pointer hover:bg-muted/50">
                      <TableCell className="font-mono text-xs">
                        <Link to={`/gc-dashboard/projects/${pa.project_id}?tab=budget`} className="hover:underline">
                          #{pa.application_number}
                        </Link>
                      </TableCell>
                      <TableCell>
                        <Link to={`/gc-dashboard/projects/${pa.project_id}`} className="hover:underline text-primary">
                          {pa.project?.name}
                        </Link>
                      </TableCell>
