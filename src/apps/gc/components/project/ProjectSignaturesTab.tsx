...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/apps/gc/components/ui/card";
import { Badge } from "@/apps/gc/components/ui/badge";
import { Button } from "@/apps/gc/components/ui/button";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/apps/gc/components/ui/tabs";
import { Input } from "@/apps/gc/components/ui/input";
import { Checkbox } from "@/apps/gc/components/ui/checkbox";
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from "@/apps/gc/components/ui/table";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/apps/gc/components/ui/select";
import {
  Loader2,
  CheckCircle2,
  Clock,
...
import { useSignatureDashboard, SignatureDocument } from "@/apps/gc/hooks/useSignatureDashboard";
import { useCancelSignatureRequest, useResendSignatureRequest, useSendSignatureReminder } from "@/apps/gc/hooks/useSignatureRequests";
import { useCreateAuditLog } from "@/apps/gc/hooks/useSignatureAuditLog";
...
import { usePayApplications } from "@/apps/gc/hooks/useBudget";
import { useChangeOrders } from "@/apps/gc/hooks/useChangeOrderMutations";
import { useProjectMembers } from "@/apps/gc/hooks/useProjectDetail";
