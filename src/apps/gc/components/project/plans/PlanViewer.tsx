...
import { PlanPin, PIN_TYPES } from "@/apps/gc/hooks/usePlans";
import { useAnnotations, AnnotationType, PlanAnnotation } from "@/apps/gc/hooks/useAnnotations";
import { useAnnotationHistory, HistoryAction } from "@/apps/gc/hooks/useAnnotationHistory";
import { useScaleCalibration, ScaleCalibration, MeasurementUnit, calculatePixelDistance } from "@/apps/gc/hooks/useScaleCalibration";
import { useAnnotationLayers } from "@/apps/gc/hooks/useAnnotationLayers";
import { TemplateAnnotation } from "@/apps/gc/hooks/useAnnotationTemplates";
...
const PlanViewer = forwardRef<PlanViewerHandle, PlanViewerProps>(({
  ...
  const handleClearAllAnnotations = useCallback(() => {
    if (confirm("Are you sure you want to clear all annotations from this plan?")) {
