...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/apps/gc/components/ui/collapsible";
...
import {
  ...
  useUpdatePin,
  useDeletePin,
} from "@/apps/gc/hooks/usePlans";
import { useTeamMembers } from "@/apps/gc/hooks/useTeamMembers";
import { useProjectRFIs, useCreateRFI, useProject } from "@/apps/gc/hooks/useProjectDetail";
import { usePinComments } from "@/apps/gc/hooks/usePinComments";
