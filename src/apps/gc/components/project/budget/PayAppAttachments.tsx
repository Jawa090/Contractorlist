...
import { usePayAppAttachments, useUploadPayAppAttachment, useDeleteAttachment, getAttachmentUrl } from "@/apps/gc/hooks/usePayAppAttachments";
...
export default function PayAppAttachments({ projectId, payApplicationId }: PayAppAttachmentsProps) {
  ...
  const handleDelete = (attachment: { id: string; file_path: string }) => {
            ...
            >
              ...
              <div className="flex gap-1">
                ...
                <Button
                  ...
                  onClick={() => handleDelete({ id: attachment.id, file_path: attachment.file_path })}
                >
